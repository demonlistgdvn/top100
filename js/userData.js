...
function getUserData(user) {
    ...
    for (var i = 0 ; i < user_data[user].verified.length ; i++) {
        ...
        clears++;
        progresses = progresses + '<li>' + list[rank].name + '</strong>(#'+(rank+1)+' - First to beat / UP: '+roundNumber(getUserPoint(rank+1, 100, list[rank].percentToQualify, "144hz")*1, 3)+')<strong></a></li>'
    }
